...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])("#timer", "2021-8-5");
});
...
var timer = function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    ...
    updateClock(); //runs updateclock in every 1 seconds
    ...
    function updateClock() {
      ...
      seconds.innerHTML = addZero(t.seconds); //calls getTimeRemaining then sets time by innerHTML
